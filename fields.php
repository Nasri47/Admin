...
<html>
	...
	<body>
		...
		<div class="w3-bar w3-border w3-teal w3-row">
			...
			<div class="">
				<a href="fields.html" class="w3-bar-item w3-button w3-padding-16 w3-col s2 w3-center w3-white w3-text-teal">Fields</a>
		    </div>
		    <div class="w3-col s2 w3-center">
				<div id="leftSide" class="w3-panel w3-center">
				</div>
			</div>
				<a href="#" class="w3-bar-item w3-button w3-padding-16 w3-col s1 w3-center">Link 2</a>
		</div>
